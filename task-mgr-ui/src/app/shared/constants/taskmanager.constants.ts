...
export class TaskManagerConstants{
    ...
    public static SEARCH_USERS:string='/api/projectmanager/findUsersByName';
    ...
    public static FIND_PROJECTS_BY_NAME:string='/api/projectmanager/findProjectsByName';
    ...
    public static SAVE_TASK:string='/api/projectmanager/saveOrUpdateTask';
